...
export const WOBBLE_CHARACTERS: Record<WobbleShape, WobbleCharacter> = {
    circle: {
        shape: 'circle',
        name: { ko: '워비', en: 'Wobi', ja: 'ウォビ', 'zh-CN': '沃比', 'zh-TW': '沃比', es: 'Wobi', pt: 'Wobi' },
        personality: {
            ko: '호기심 많고 활발한 주인공',
            ...
            'zh-CN': '好奇心旺盛的活力主角',
            'zh-TW': '好奇心旺盛的活力主角',
            es: 'Protagonista curioso y enérgico',
            pt: 'Protagonista curioso e enérgico',
        },
        role: 'protagonist',
        color: 0xf5b041,
    },
    square: {
        shape: 'square',
        name: { ko: '박시', en: 'Boxy', ja: 'ボクシー', 'zh-CN': '方方', 'zh-TW': '方方', es: 'Boxy', pt: 'Boxy' },
        personality: {
            ko: '순하고 자주 당하는 타입',
            ...
            'zh-CN': '温和常被欺负的类型',
            'zh-TW': '溫和常被欺負的類型',
            es: 'Gentil y a menudo empujado',
            pt: 'Gentil e frequentemente empurrado',
        },
        role: 'victim',
        color: 0x5dade2,
    },
    triangle: {
        shape: 'triangle',
        name: { ko: '스파이크', en: 'Spike', ja: 'スパイク', 'zh-CN': '尖尖', 'zh-TW': '尖尖', es: 'Spike', pt: 'Spike' },
        personality: {
            ko: '날카롭고 도전적인 성격',
            ...
            'zh-CN': '尖锐且好胜的挑战者',
            'zh-TW': '尖銳且好勝的挑戰者',
            es: 'Desafiante agudo y competitivo',
            pt: 'Desafiador afiado e competitivo',
        },
        role: 'attacker',
        color: 0xe74c3c,
    },
    star: {
        shape: 'star',
        name: { ko: '트윙클', en: 'Twinkle', ja: 'トゥインクル', 'zh-CN': '闪闪', 'zh-TW': '閃閃', es: 'Twinkle', pt: 'Twinkle' },
        personality: {
            ...
            'zh-CN': '特别且带来好运的存在',
            'zh-TW': '特別且帶來好運的存在',
            es: 'Especial y trae buena suerte',
            pt: 'Especial e traz boa sorte',
        },
        role: 'bonus',
        color: 0xffd700,
    },
    diamond: {
        shape: 'diamond',
        name: { ko: '젬', en: 'Gem', ja: 'ジェム', 'zh-CN': '宝石', 'zh-TW': '寶石', es: 'Gema', pt: 'Gema' },
        personality: {
            ...
            'zh-CN': '珍贵且目标导向的性格',
            'zh-TW': '珍貴且目標導向的性格',
            es: 'Precioso y orientado a metas',
            pt: 'Precioso e orientado a metas',
        },
        role: 'goal',
        color: 0xbb8fce,
    },
    pentagon: {
        shape: 'pentagon',
        name: { ko: '펜타', en: 'Penta', ja: 'ペンタ', 'zh-CN': '五角', 'zh-TW': '五角', es: 'Penta', pt: 'Penta' },
        personality: {
            ko: '믿음직하고 든든한 보호자',
            ...
            'zh-CN': '可靠的保护者和支持者',
            'zh-TW': '可靠的保護者和支持者',
            es: 'Protector confiable y solidario',
            pt: 'Protetor confiável e solidário',
        },
        role: 'defender',
        color: 0x82e0aa,
    },
    shadow: {
        shape: 'shadow',
        name: { ko: '섀도우', en: 'Shadow', ja: 'シャドウ', 'zh-CN': '暗影', 'zh-TW': '暗影', es: 'Sombra', pt: 'Sombra' },
        personality: {
            ko: '어둠에서 온 법칙 파괴자',
            ...
            'zh-CN': '来自虚空的法则破坏者',
            'zh-TW': '來自虛空的法則破壞者',
            es: 'Destructor de leyes desde el vacío',
            pt: 'Destruidor de leis do vazio',
        },
        role: 'enemy',
        color: 0x1a1a1a,
    },
    einstein: {
        shape: 'einstein',
        name: { ko: '알버트', en: 'Albert', ja: 'アルバート', 'zh-CN': '阿尔伯特', 'zh-TW': '阿爾伯特', es: 'Alberto', pt: 'Alberto' },
        personality: {
            ...
            'zh-CN': '充满好奇心的天才科学家',
            'zh-TW': '充滿好奇心的天才科學家',
            es: 'Científico genio lleno de curiosidad',
            pt: 'Cientista gênio cheio de curiosidade',
        },
        role: 'scientist',
...
export const FORMULA_WOBBLES: Record<string, WobbleShape[]> = {
    ...
    'beat-frequency': ['circle', 'star'], // Two tuning forks + beat star
    snell: ['circle'],
    reflection: ['circle'],
    lens: ['circle'],
