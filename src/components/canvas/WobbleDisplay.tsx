    ...
    useEffect(() => {
        ...
        const initApp = async () => {
            ...
            try {
                ...
                // Wrap render to catch PixiJS v8 Batcher errors from concurrent app destroys
        ...
        return () => {
            ...
            if (currentApp) {
                ...
                // Deferred destroy to avoid PixiJS v8 shared Batcher corruption
                // Match usePixiApp pattern: destroy(false) to avoid GlobalResourceRegistry.release()
                setTimeout(() => {
                    try {
                        if (currentWobble) {
