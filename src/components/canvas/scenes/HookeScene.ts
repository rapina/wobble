...
export class HookeScene extends BaseScene {
    ...
    private drawElasticBands(blobX: number, blobY: number, displacement: number): void {
        ...
        this.drawWavyBand(g, this.leftAnchorX, anchorY, blobX - blobRadius, anchorY, leftThickness, leftColor, leftStretch);
        ...
        this.drawWavyBand(g, blobX + blobRadius, anchorY, this.rightAnchorX, anchorY, rightThickness, rightColor, rightStretch);
