...
import { ArrowLeft, Sparkles, BookOpen, Trophy, Users, Target, Waves, Check, Loader2 } from 'lucide-react'
...
export function CollectionScreen({ onBack }: CollectionScreenProps) {
    ...
    // Initial loading phase - allow heavy WebGL components to initialize
    useEffect(() => {
    ...
    // Memoize Balatro background to prevent re-render on state changes
    ...
    if (isInitialLoading) {
        return (
            ...
            >
                ...
                {[...Array(12)].map((_, i) => (
                    ...
                    >
                        <Sparkles
                            className="w-4 h-4"
                            style={{
                                color: i % 3 === 0 ? theme.gold : i % 3 === 1 ? theme.blue : theme.purple,
                                filter: `drop-shadow(0 0 6px ${i % 3 === 0 ? theme.gold : i % 3 === 1 ? theme.blue : theme.purple})`,
                            }}
                        />
                    </div>
                ))}
                ...
                {/* Wobble parade - 3 characters bouncing */}
                <div className="relative flex items-end gap-4 mb-8">
                    {(['circle', 'star', 'triangle'] as const).map((shape, i) => (
                        <div
                            key={shape}
                            className="animate-wobble-bounce"
                            style={{
                ...
                {/* Title card */}
                <div
                    className="relative px-8 py-4 rounded-xl mb-6"
                    style={{
                        background: theme.bgPanel,
                        border: `3px solid ${theme.gold}`,
                        boxShadow: `0 6px 0 ${theme.border}, 0 0 40px ${theme.gold}30`,
                    }}
                >
                    <div className="flex items-center gap-3">
                        <Trophy className="w-7 h-7 animate-pulse" style={{ color: theme.gold }} />
                        <span
                ...
                <div className="w-48">
                    ...
                    >
                        <div
                            className="h-full rounded-full animate-loading-fill"
                            style={{
                                background: `linear-gradient(90deg, ${theme.blue}, ${theme.gold}, ${theme.purple})`,
                                boxShadow: `0 0 10px ${theme.gold}60`,
                            }}
                        />
                    </div>
                </div>
                ...
                <div className="mt-4 flex items-center gap-2">
                    <Loader2 className="w-4 h-4 animate-spin" style={{ color: theme.gold }} />
                    <span
                ...
                <style>{`
                    ...
                    .animate-float-sparkle { animation: float-sparkle 2s ease-in-out infinite; }

                    @keyframes wobble-bounce {
                        0%, 100% { transform: translateY(0) scale(1); }
                        50% { transform: translateY(-20px) scale(1.05); }
                    }
                    .animate-wobble-bounce { animation: wobble-bounce 0.8s ease-in-out infinite; }
                    ...
                    .animate-loading-fill { animation: loading-fill 0.4s ease-out forwards; }
                `}</style>
            </div>
        )
    }
    ...
    const tabs: { id: TabType; icon: React.ReactNode; label: string }[] = [
        {
            ...
            label: t('collection.tabs.characters'),
        },
        {
            id: 'formulas',
            icon: <BookOpen className="w-3.5 h-3.5" />,
            label: t('collection.tabs.study'),
        },
        {
            id: 'achievements',
            icon: <Trophy className="w-3.5 h-3.5" />,
            label: t('collection.tabs.achieve'),
        },
        {
            id: 'records',
            icon: <Target className="w-3.5 h-3.5" />,
            label: t('collection.tabs.records'),
        },
    ]
                                ...
                                <div className="px-3 pb-4 text-center">
                                    ...
                                    >
                                        {unlocked
                                            ...
                                            : t('collection.characters.notDiscovered')}
                                    </p>
                                </div>
...
function FormulasTab({
    ...
    const categories = [
        {
            id: 'mechanics',
            name: t('collection.formulas.mechanics'),
            color: theme.red,
            formulas: [
                'newton-second',
                'kinetic-energy',
        ...
        {
            id: 'gravity',
            name: t('collection.formulas.gravity'),
            color: theme.purple,
            formulas: [
                'gravity',
                'pendulum',
        ...
        {
            id: 'waves',
            name: t('collection.formulas.waves'),
            color: theme.blue,
            formulas: [
                'wave',
                'reflection',
        ...
        {
            id: 'thermo',
            name: t('collection.formulas.thermo'),
            color: '#e67e22',
            formulas: [
                'ideal-gas',
                'heat',
        ...
        {
            id: 'electricity',
            name: t('collection.formulas.electricity'),
            color: '#f1c40f',
            formulas: [
                'ohm',
                'coulomb',
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            <h3 className="font-black text-white text-sm">
                                {t('collection.records.wobblediver')}
                            </h3>
                            <p
                                className="text-[10px] font-medium"
                                style={{ color: abyssTheme.teal }}
                            >
                                {t('collection.records.abyssDiving')}
                            </p>
                        </div>
                        {/* Best Rank Badge */}
                        <div
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            >
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-[10px] font-medium text-white/50">
                                        {t('collection.records.bestDepth')}
                                    </span>
                                </div>
                                <div
                            ...
                            >
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-[10px] font-medium text-white/50">
                                        {t('collection.records.highScore')}
                                    </span>
                                </div>
                            ...
                            >
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-[10px] font-medium text-white/50">
                                        {t('collection.records.totalGames')}
                                    </span>
                                </div>
                        ...
                        >
                            {hasRecords ? (
                                ...
                                <span className="text-white/30 w-full text-center">
                                    {t('collection.records.noRecords')}
                                </span>
                            )}
                        </div>
                    </div>
                    ...
                    {wobblediverRecord.lastPlayedAt && (
                        ...
                        >
                            {t('collection.records.lastPlayed')}
            ...
            >
                ...
                >
                    <p className="text-white/40 text-xs font-medium">
                        {t('collection.records.moreGames')}
                    </p>
                </div>
            </div>
        </div>
    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative flex items-center justify-between mb-3">
                    <span className="text-white/60 text-sm font-bold">
                        {t('collection.achievements.overallProgress')}
                    </span>
                    <div
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        >
                            {t('collection.achievements.challenges')}
                        </h3>
                    </div>
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        ...
                                        {!isMaxLevel && nextLevel && (
                                            <>
                                                ...
                                                <div className="flex justify-between text-xs">
                                                    ...
                                                    >
                                                        {t('collection.achievements.next')}
                                        ...
                                        {isMaxLevel && (
                                            ...
                                            >
                                                {t('collection.achievements.maxLevel')}
                                            </p>
                                        )}
                                    </div>
                                </div>
            ...
            {visibleUnlockedCount < visibleTotalCount && (
                ...
                >
                    {t('collection.achievements.keepExploring')}
                </p>
            )}
        </>
    )
