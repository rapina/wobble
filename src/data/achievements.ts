...
export const ACHIEVEMENTS: Achievement[] = [
    // ============ Learning (학습) ============
    {
        ...
        description: { ko: '첫 번째 공식을 학습하세요', en: 'Study your first formula', ja: '最初の公式を学習しよう' },
    ...
    },
    {
        ...
        description: { ko: '5개의 공식을 학습하세요', en: 'Study 5 formulas', ja: '5つの公式を学習しよう' },
    ...
    },
    {
        ...
        description: { ko: '15개의 공식을 학습하세요', en: 'Study 15 formulas', ja: '15の公式を学習しよう' },
    ...
    },
    {
        ...
        description: { ko: '35개의 모든 공식을 학습하세요', en: 'Study all 35 formulas', ja: '35の公式を全て学習しよう' },
    ...
    // ============ Combat (전투) ============
    {
        ...
        description: { ko: '첫 번째 적을 처치하세요', en: 'Defeat your first enemy', ja: '最初の敵を倒そう' },
    ...
    },
    {
        ...
        description: { ko: '총 100마리의 적을 처치하세요', en: 'Defeat 100 enemies total', ja: '合計100体の敵を倒そう' },
    ...
    },
    {
        ...
        description: { ko: '총 500마리의 적을 처치하세요', en: 'Defeat 500 enemies total', ja: '合計500体の敵を倒そう' },
    ...
    },
    {
        ...
        description: { ko: '3분 동안 생존하세요', en: 'Survive for 3 minutes', ja: '3分間生き残ろう' },
    ...
    // ============ Collection (수집) ============
    {
        ...
        description: { ko: '첫 번째 워블을 해금하세요', en: 'Unlock your first Wobble', ja: '最初のワブルを解放しよう' },
    ...
    },
    {
        ...
        description: { ko: '7개의 모든 워블을 해금하세요', en: 'Unlock all 7 Wobbles', ja: '7体のワブルを全て解放しよう' },
    ...
    // ============ Mastery (마스터리) ============
    {
        ...
        description: { ko: 'C 랭크 이상을 달성하세요', en: 'Achieve C rank or higher', ja: 'Cランク以上を達成しよう' },
    ...
    },
    {
        ...
        description: { ko: 'B 랭크 이상을 달성하세요', en: 'Achieve B rank or higher', ja: 'Bランク以上を達成しよう' },
    ...
    },
    {
        ...
        description: { ko: 'A 랭크 이상을 달성하세요', en: 'Achieve A rank or higher', ja: 'Aランク以上を達成しよう' },
    ...
    },
    {
        ...
        description: { ko: '전설의 S 랭크를 달성하세요', en: 'Achieve the legendary S rank', ja: '伝説のSランクを達成しよう' },
...
export const CATEGORY_INFO: Record<
    AchievementCategory,
    { name: LocalizedText; color: string }
> = {
