...
/** Value type for mission params - can be string, number, or LocalizedText for variable names */
export type MissionParamValue = string | number | LocalizedText

export interface Challenge {
    id: string
    type: ChallengeType
    formulaId: string
    /** @deprecated Use missionKey + missionParams instead */
    mission?: string
    /** @deprecated Use missionKey + missionParams instead */
    missionEn?: string
    /** i18n key for mission template (e.g., 'sandbox.missions.target') */
    missionKey: string
    /** Parameters for mission template interpolation */
    missionParams: Record<string, MissionParamValue>
