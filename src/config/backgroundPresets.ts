...
// Category-specific presets for Formula Carousel
export const mechanicsPreset: BackgroundPreset = {
    color1: '#f8b862',
    color2: '#8a5a2d',
    color3: '#351a0d',
    spinSpeed: 1.0,
...
export const wavePreset: BackgroundPreset = {
    color1: '#6ecff6',
    color2: '#2d5a8a',
    color3: '#0d1a35',
    spinSpeed: 0.8,
...
export const gravityPreset: BackgroundPreset = {
    color1: '#c792ea',
    color2: '#5d3d8a',
    color3: '#1a0d35',
    spinSpeed: 0.6,
...
export const thermodynamicsPreset: BackgroundPreset = {
    color1: '#ff6b6b',
    color2: '#8a3d4a',
    color3: '#350d15',
    spinSpeed: 1.5,
...
export const electricityPreset: BackgroundPreset = {
    color1: '#69f0ae',
    color2: '#2d6b3d',
    color3: '#0d351a',
    spinSpeed: 2.0,
...
export const specialPreset: BackgroundPreset = {
    color1: '#ffd700',
    color2: '#8a6b2d',
    color3: '#352d0d',
    spinSpeed: 0.9,
...
export const quantumPreset: BackgroundPreset = {
    color1: '#e040fb',
    color2: '#5d2060',
    color3: '#1a0d20',
    spinSpeed: 1.2,
...
export const chemistryPreset: BackgroundPreset = {
    color1: '#4fc3f7',
    color2: '#2d5a6b',
    color3: '#0d2035',
    spinSpeed: 0.7,
...
// Map category IDs to their presets
import { FormulaCategory } from '@/formulas/types'

export const categoryBackgrounds: Record<FormulaCategory, BackgroundPreset> = {
    mechanics: mechanicsPreset,
    wave: wavePreset,
    gravity: gravityPreset,
    thermodynamics: thermodynamicsPreset,
    electricity: electricityPreset,
    special: specialPreset,
    quantum: quantumPreset,
