...
export const elasticCollision: Formula = {
    ...
    variables: [
        {
            symbol: 'm₁',
            name: { ko: '질량 1', en: 'Mass 1', ja: '質量1', es: 'Masa 1', pt: 'Massa 1', 'zh-CN': '质量1', 'zh-TW': '質量1' },
            role: 'input',
            unit: 'kg',
            range: [1, 20],
            default: 10,
        ...
        {
            symbol: 'm₂',
            name: { ko: '질량 2', en: 'Mass 2', ja: '質量2', es: 'Masa 2', pt: 'Massa 2', 'zh-CN': '质量2', 'zh-TW': '質量2' },
            role: 'input',
            unit: 'kg',
            range: [1, 20],
            default: 5,
        ...
        {
            symbol: 'v₁',
            name: { ko: '속도 1', en: 'Velocity 1', ja: '速度1', es: 'Velocidad 1', pt: 'Velocidade 1', 'zh-CN': '速度1', 'zh-TW': '速度1' },
            role: 'input',
            unit: 'm/s',
            range: [1, 10],
            default: 5,
        ...
        {
            symbol: 'e',
            name: { ko: '반발 계수', en: 'Restitution Coeff.', ja: '反発係数', es: 'Coef. Restitución', pt: 'Coef. Restituição', 'zh-CN': '恢复系数', 'zh-TW': '恢復係數' },
            role: 'input',
            unit: '',
            range: [0, 1],
            default: 0.8,
        ...
        {
            symbol: "v₁'",
            name: { ko: '충돌 후 속도 1', en: 'Velocity 1 After', ja: '衝突後速度1', es: 'Velocidad 1 Después', pt: 'Velocidade 1 Após', 'zh-CN': '碰撞后速度1', 'zh-TW': '碰撞後速度1' },
            role: 'output',
            unit: 'm/s',
            range: [-10, 10],
            default: 1.67,
