...
export function useLocalizedFormula(formula: Formula | null): LocalizedFormula | null {
    ...
    return {
        ...
        description: isEnglish && formula.descriptionEn ? formula.descriptionEn : formula.description,
        applications: isEnglish && formula.applicationsEn ? formula.applicationsEn : (formula.applications ?? []),
    };
}
